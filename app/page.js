      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-12">
            ...
            <h1 className="text-6xl font-bold bg-gradient-to-r from-[#6C8EF9] to-[#8B7FF9] bg-clip-text text-transparent mb-4 leading-tight pb-2">UA Digital Card System</h1>
