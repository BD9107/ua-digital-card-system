...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#003366] to-[#004488]">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          {/* Header */}
          <div className="mb-12">
            <div className="w-20 h-20 bg-[#FFD700] rounded-full mx-auto mb-6 flex items-center justify-center">
          ...
          <div className="space-y-4">
            <Link
              href="/admin/login"
              className="inline-block bg-[#FFD700] text-[#003366] px-8 py-4 rounded-lg font-semibold text-lg hover:bg-[#FFC700] transition-colors shadow-lg"
            >
              Admin Login
            </Link>
