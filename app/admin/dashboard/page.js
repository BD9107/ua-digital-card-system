        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex gap-3">
            {canAddEmployee ? (
              ...
              <button disabled className="btn-primary flex items-center gap-2 opacity-50 cursor-not-allowed" title="You don't have permission">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
                Add Employee
            ...
            {canAddEmployee ? (
              ...
              <button disabled className="btn-secondary flex items-center gap-2 opacity-50 cursor-not-allowed" title="You don't have permission">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                </svg>
                Import CSV
                  ...
                  <td className="px-6 py-5">
                    <div className="flex items-center justify-end gap-3">
                      {canEditEmployee ? (
                        ...
                        <span className="p-2.5 text-gray-300 cursor-not-allowed" title="No permission">
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                          </svg>
                        </span>
                      ...
                      {canChangeEmployeeStatus ? (
                        <div className="flex items-center gap-2 p-2 bg-gray-50 rounded-xl min-w-[110px]">
                          <Switch
                        ...
                        <div className="flex items-center gap-2 p-2 bg-gray-50 rounded-xl min-w-[110px] opacity-50">
                          <Switch checked={employee.is_active} disabled className="cursor-not-allowed" />
                          <span className={`text-xs font-medium w-14 ${employee.is_active ? 'text-[#4caf50]' : 'text-gray-500'}`}>
                            {employee.is_active ? 'Active' : 'Inactive'}
                          </span>
                        </div>
                      ...
                      {canDeleteEmployee ? (
                        ...
                        <span className="p-2.5 text-gray-300 cursor-not-allowed" title="Only Overwatch can delete">
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                          </svg>
                        </span>
