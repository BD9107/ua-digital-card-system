        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <div className="px-6 pb-6">
            ...
            <div className="space-y-3 mb-6">
              ...
              {employee.phone && (
                <a 
                  ...
                  className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors elevation-2"
                >
                  <div className="w-10 h-10 bg-gradient-to-br from-[#C4B896] to-[#D1C7A8] rounded-full flex items-center justify-center flex-shrink-0 shadow-sm">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-[#1B9E9E] to-[#2AB8B8] text-white py-4 rounded-xl font-semibold text-lg hover:shadow-xl transition-all duration-200 shadow-lg flex items-center justify-center gap-2"
            >
