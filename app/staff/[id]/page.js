      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden elevation-8">
          ...
          <div className="px-6 pb-6">
            ...
            {employee.job_title && (
              <p className="text-center text-lg text-[#0033AA] font-medium mb-1">
                {employee.job_title}
              </p>
            )}
            ...
            <div className="space-y-3 mb-6">
              {employee.email && (
                ...
                >
                  <div className="w-10 h-10 bg-[#002147] rounded-full flex items-center justify-center flex-shrink-0">
